...
from dexmimicgen.environments.single_arm_dexmg_env import SingleArmDexMGEnv
from dexmimicgen.models.objects import DrawerObject


class SingleArmDrawerCleanup(SingleArmDexMGEnv):
    ...
    def __init__(
        ...
        render_camera="agentview", # frontview
    ...
    def reward(self, action=None):
        ...
        if not self._drawer_opened and self._check_drawer_open():
    ...
    def _reset_internal(self):
        ...
        super(SingleArmDexMGEnv, self)._reset_internal()
        self._drawer_opened = False
    ...
    def _check_drawer_close(self):
        ...
        drawer_closed = self.sim.data.qpos[self.drawer_qpos_addr] > -0.05
        return drawer_closed

    def _check_drawer_open(self):
        drawer_open = self.sim.data.qpos[self.drawer_qpos_addr] < -0.15
        return drawer_open
